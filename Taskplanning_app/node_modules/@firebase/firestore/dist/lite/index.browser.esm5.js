 ...
 * limitations under the License.
 */
var g = "10.4.0", w = new l("@firebase/firestore");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var P = "cancelled", F = "unknown", O = "invalid-argument", V = "deadline-exceeded", N = "not-found", D = "permission-denied", q = "unauthenticated", R = "resource-exhausted", x = "failed-precondition", C = "aborted", L = "out-of-range", j = "unimplemented", M = "internal", U = "unavailable", B = /** @class */ function(e) {
    /** @hideconstructor */
    function n(
    /**
 ...
 */ function On(t, e) {
    ...
    if (!(t instanceof Pn || t instanceof Fn)) throw new B(O, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
 ...
 */ function Vn(t, e) {
    if (t = ct(t, _n), ot("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new B(O, "Invalid collection ID '".concat(e, "' passed to function collectionGroup(). Collection IDs must not contain '/'."));
    return new An(t, 
...
var Jn = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new Re(t.serializer, Oe(t.serializer, this.At));
    ...
    if (n[0] = p(n[0]), n[0] instanceof hr) return function(t, e, n, r, i) {
        ...
        for (var o = [], a = 0, u = Ie(t); a < u.length; a++) {
            ...
            if (s.field.isKeyField()) o.push(zt(e, r.key)); else {
                ...
                if (qt(c)) throw new B(O, 'Invalid query. You are trying to start or end a query using a document for which the field "' + s.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
...
function Ur(t, e) {
    if (!(e instanceof _r || e instanceof Tr)) throw new B(O, "Function ".concat(t, "() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'."));
}
...
a("firestore-lite", "4.2.0", ""), a("firestore-lite", "4.2.0", "esm5");
